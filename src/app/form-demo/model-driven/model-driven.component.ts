...
import { FormBuilder, FormArray, FormGroup, Validators,ValidatorFn} from '@angular/forms';
...
export class ModelDrivenComponent implements OnInit {
  ...
  // onProvinceChange(){
  //   this.cities = getCitiesByProvince(this.user.get())
  // }
  //
  // onCityChange(province,city){
  //   this.areas = getAreasByCity()
  // }
